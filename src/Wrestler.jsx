...
const roster = [
  new Wrestler("Pancake Perkins", "Portland", "Male", 6, 8, 4, 9, 7, 3, 2, "Wild"),
  new Wrestler("The Spicy Ottoman", "Istanbul", "Male", 8, 6, 5, 7, 9, 4, 3, "Grappler"),
  new Wrestler("Uncle Dynamite", "Nashville", "Male", 9, 7, 6, 8, 8, 5, 4, "Tough"),
  new Wrestler("Skyflash Solis", "Phoenix", "Female", 5, 9, 10, 6, 4, 9, 1, "Wild"),
  ...
  new Wrestler("Valkyrie Vega", "Las Vegas", "Female", 8, 7, 9, 8, 7, 8, 2, "Tough"),
  new Wrestler("Ember Thorne", "Atlanta", "Female", 6, 8, 7, 7, 5, 6, 4, "Tough"),
  new Wrestler("Sapphire Vandal", "Miami", "Female", 7, 6, 9, 10, 6, 8, 3, "Wild"),
  new Wrestler("Nova Tempest", "Seattle", "Female", 5, 9, 8, 6, 4, 9, 2, "Wild"),
  ...
  new Wrestler("Ironjaw Magnus", "Pittsburgh", "Male", 10, 9, 4, 4, 10, 3, 6, "Grappler"),
